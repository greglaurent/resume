...
//   #let (heading-1, text-1, link, emphasis, strong, code, code-block, quote, figure-caption,
//         list, enum, figure) = l
//   #show: l.page
//   #show: l.markup
//   = Heading
...
#let _build-specs(t) = (
  text-1:         (step: 0,    category: "body",    defaults: (fill: t.fg),                              render: utils.render-text),
  text-2:         (step: -1,   category: "body",    defaults: (fill: t.fg),                              render: utils.render-text),
  text-3:         (step: -2,   category: "body",    defaults: (fill: t.fg-muted),                        render: utils.render-text),
  ...
  heading-1:      (step: 4,    category: "heading", defaults: (weight: 700, fill: t.fg),                 render: utils.render-text),
  heading-2:      (step: 3,    category: "heading", defaults: (weight: 600, fill: t.fg),                 render: utils.render-text),
  heading-3:      (step: 2,    category: "heading", defaults: (weight: 600, fill: t.fg),                 render: utils.render-text),
  heading-4:      (step: 1,    category: "heading", defaults: (weight: 600, fill: t.fg),                 render: utils.render-text),
...
#let make(
  ...
  // `#show: l.markup`. Body defaults match text-1 (body-category scale step 0).
