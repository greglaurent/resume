#let content = (
  (
    ...
    summary: [Founded consulting practice focused on technical leadership and mentorship for product and engineering teams. Guide clients through technical challenges, feasibility analysis, process optimization, and product delivery.],
    bullets: (
      [*Revenue-Generating Innovation:* Guided client through developing new discovery methodology for early-phase technical research, enabling them to land larger, more complex projects and generate #emph[\$550K in additional revenue.]],
      [*Emerging Technology R&D:* Embedded with clients across domains to conduct feasibility studies and proof-of-concept development for emerging technologies, including subterranean leak detection systems and marketing attribution models with #emph[IP/patent strategy support.]],
